...
class User < ActiveRecord::Base
	...
	has_many :purchases, :dependent => true, :order => "purchaseDate DESC", :conditions=>"visible = 1"
	has_many :wishes, :dependent => true, :order => "wishDate DESC", :conditions=>"visible = 1"
	has_many :buddies, :class_name => "user"
